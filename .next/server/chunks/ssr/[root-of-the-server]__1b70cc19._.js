...
const DashboardPage = ()=>{
    return(// <div className="h-screen w-64 bg-gradient-to-b via-white to-green-200 rounded-r-xl shadow-xl p-6">
    //     <Link className="text-2xl font-extrabold text-green-600 text-center mb-4" href="/">The Green College</Link>
    //     <div className="flex flex-col space-y-2 mb-4">
    //         <div>
    //             <Link href="../student" className="flex items-center px-4 py-3 gap-4 rounded-lg  hover:text-white  hover:bg-green-600">
    //                 <p className="text-center">Student</p>
    //             </Link>
    //             <Link href="./admin" className="flex items-center px-4 py-3 gap-4 rounded-lg  hover:text-white  hover:bg-green-600">
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1b70cc19._.js.map